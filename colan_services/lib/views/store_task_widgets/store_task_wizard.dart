...
import '../../store_tasks_service/builders/get_store_tasks.dart';
import '../../store_tasks_service/builders/with_active_task_override.dart';
import '../../store_tasks_service/models/active_store_task.dart';
import '../../store_tasks_service/models/content_origin.dart';
        ...
        return SafeArea(
          child: WithActiveTaskOverride(
            task: ActiveStoreTask(
                ...
                targetConfirmed:
                    task.contentOrigin == ContentOrigin.deleted ? true : null),
